...
![Project Pipeline](https://github.com/kpoornasai121/Walmart_SQL_Project/blob/main/walmart_project-piplelines.png)
...
1. Clone the repository:
   ```bash
   git clone https://github.com/kpoornasai121/Walmart_SQL_Project
   ```
